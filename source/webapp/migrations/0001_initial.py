# Generated by Django 4.0 on 2022-02-10 14:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('summary', models.CharField(max_length=200, validators=[django.core.validators.MinLengthValidator(10)], verbose_name='Краткое описание')),
                ...
                ('project', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project', to='webapp.project', verbose_name='Проект')),
                ...
                ('type', models.ManyToManyField(blank=True, related_name='type', to='webapp.Type', verbose_name='Тип')),
            ],
        ),
    ]
